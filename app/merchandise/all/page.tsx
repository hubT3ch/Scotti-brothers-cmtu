...
export default function AllProductsPage() {
  ...
  useEffect(() => {
    ...
    async function loadCatalog() {
      try {
        ...
        console.error(
          "Public all-products catalog error:",
          loadError,
        );
   ...
   * filter by category.
   *
   * It displays every product returned
   * by the public merchandise catalog
   * that is active and public.
   *
   * Featured status does NOT determine
   * whether a product appears here.
   *
   * A Featured product will therefore
   * appear here as well.
   */
  const allProducts =
    useMemo(() => {
